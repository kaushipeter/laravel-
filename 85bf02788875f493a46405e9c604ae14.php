                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex items-center justify-end">
                            <a href="<?php echo e(route('admin.products.index')); ?>" class="text-gray-600 hover:text-gray-900 mr-4">Cancel</a>
...
<?php endif; ?>
<?php /**PATH /Users/kaushipeter/Desktop/Laravel assignment/aura_by_kiyara/resources/views/admin/products/create.blade.php ENDPATH**/ ?>